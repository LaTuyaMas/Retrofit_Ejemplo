...
import com.example.sharedpreferentes.retrofit_ejemplo.adapters.PhotosAdapter;
...
public class PhotosActivity extends AppCompatActivity {
    ...
    private void doGetPhotos(String idAlbum) {
        ...
        // Por Query o por Path, hacen los mismo
        Call<ArrayList<Photo>> getPhotos = conexiones.getPhotosAlbumPath(idAlbum);
